...
type LayoutRouteId = RouteId | "/" | "/assets" | "/assets/[id]" | "/audit-log" | "/auth/emergency-reset" | "/auth/login" | "/auth/register" | "/auth/reset-password/[token]" | "/dashboard" | "/join-organization" | "/onboarding" | "/profile" | "/select-organization" | "/sites" | "/sites/[id]" | "/templates" | "/templates/[id]" | "/users" | "/users/security" | "/work-orders" | "/work-orders/[id]" | null
