...
type LayoutRouteId = RouteId | "/" | "/assets" | "/assets/[id]" | "/audit-log" | "/auth/login" | "/auth/logout" | "/auth/register" | "/dashboard" | "/profile" | "/sites" | "/sites/[id]" | "/users" | "/work-orders" | "/work-orders/[id]" | null
